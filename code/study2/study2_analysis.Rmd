...
dat_labels <- dat_summarized_by_item %>% 
  ...
  #   itemB, "\n",
  #   "Causal: ", causal_itemA, "\n",
  #   "Similar: ", similarity_itemA
  # )) 
# mutate(facet_label = paste0(
#   itemB, "\n",
#   "\U25A0 ", causal_itemA, "\n",  # black square
#   "\U25A1 ", similarity_itemA    # white square (or use light gray block)
# )) 
# mutate(facet_label = paste0(
#   itemB, "\n",
#   "■ ", causal_itemA, "\n",  # black square
...
ggsave(
  filename = "figures/p_study2_item-level_stacked_v2.pdf",
  plot = p_alt2,          
  device = "pdf",           
  width = 12,               
  height = 8,             
