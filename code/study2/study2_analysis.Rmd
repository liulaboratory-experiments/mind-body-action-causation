...
snapshots_output_path <- paste0(base_path, "/study2/snapshots_study2_analysis")
freesort_and_causal_distances_df_path <- paste0(snapshots_input_path, "/relative_distances.csv")
