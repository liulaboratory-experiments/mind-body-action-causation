...
data_processed_output_path <- paste0(snapshots_output_path, "/data_processed_step2.csv") #this dataframe is not used in a subsequent script. It is just being saved for efficiency
correlations_output_path <- paste0(snapshots_output_path, "/correlations.csv") #this isn't used in this script
...
# Freesort minus causal distances for Study 2
