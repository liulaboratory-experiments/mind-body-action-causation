...
4. Generates theoretical RDM data and saves the csv (d_theories_categories)
5. Adds USE embeddings and saves the csv (d_all_theories) 
...
freesort_output_path <- paste0(snapshots_path, "/pilot_121424_freeesort.csv") #data for Sorting Task
combined_output_path <- paste0(snapshots_path, "/", combined_output_csv, ".csv") 
theories_output_path <- paste0(snapshots_path, "/pilot_121424_theories.csv")  
theories_all_output_path <- paste0(snapshots_path, "/pilot_121424_theories_all.csv") 
...
```{r}
d_theories_categories <- expand.grid(itemA = desired_order, itemB = desired_order) %>% 
